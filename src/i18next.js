    ...
    resources: {
        ...
        translation: {
          ...
          "You can watch the instructional video and make the desired changes at the same time. In the video, select the Picture in Picture function from the icon, on the right side of the video image, and close this tab from the upper right corner.":
            "Voit katsoa opetusvideon ja tehdä haluamasi muutokset samanaikaisesti. Valitse videosta Picture in Picture -toiminto kuvakkeesta, videokuvan oikeasta reunasta, ja sulje tämä välilehti yläoikeassa kulmassa.",
          ...
          "You can also watch the video in full screen mode by selecting or from the icon from the icon to stream to another device.":
            "Voit myös katsoa videon koko näytön tilassa valitsemalla tai kuvakkeesta, kuvakkeen kautta toistaaksesi toiselle laitteelle.",
          ...
          "Destination matches": "Kohteen täsmennys",
          "Destination non-matches": "Kohteen ei täsmää",
