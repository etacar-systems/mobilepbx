<?php
    ...
    if ($json_response['msg'] == 'true') {
        ...
        $dialplan->postQueueSettings($con, $uuidSetting, $dialplan_id, $domain, $dialplan_detail_tag, $dialplan_detail_type, $dialplan_detail_data, $dialplan_detail_break, $dialplan_detail_group, $dialplan_detail_order, $id);
