<?php
    ...
    class DialplanInbound {
        ...
        public function fetch_dialplaninbound_settings($con, $id) {
        ...
        public function post($con, $uuidDialPlan, $name, $extension, $order, $domain, $context, $description, $dialplaninbound_enabled, $userID) {
            if (empty(trim($name))) {
                echo json_encode([
        ...
        public function update($con, $dialplan_inbound_id, $name, $extension, $order, $domain, $context, $description, $dialplaninbound_enabled) {
            if (empty(trim($name))) {
                echo json_encode([
                    "msg"     => 'Name Cannot be EMPTY !'
                ]);
            ...
            $updateQuery = "UPDATE public.v_dialplans SET
                ...
                dialplan_enabled = '$dialplaninbound_enabled',
                dialplan_description = '$description'
                WHERE dialplan_uuid = '$dialplan_inbound_id'";
