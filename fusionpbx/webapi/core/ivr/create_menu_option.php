<?php
    ...
    if ($json_response['msg'] == 'true') {
        ...
        $uuidMenuOptionIVR = $uuid->toString();

        if ($ivr_menu_enabled == "true" || $ivr_menu_enabled == "false") {
            $ivr->postMenuOption($con, $uuidMenuOptionIVR, $ivr_menu_id, $domain, $menu_digit, $menu_option, $menu_param, $menu_order, $ivr_menu_enabled, $id);
        } else {
            echo json_encode([
