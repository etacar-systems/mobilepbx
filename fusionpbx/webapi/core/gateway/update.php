    ...
    if ($json_response['msg'] == 'true') {
	    ...
	    $caller_id_in_from = $data->caller_id_in_from;
            if ($gateway_enabled == 'true' || $gateway_enabled == 'false') {
                $gateway->update($con, $gateway_id, $gateway_name, $username, $password, $realm, $from_user, $proxy, $expire_seconds, $register, $retry_seconds, $profile, $gateway_enabled, $context, $description, $caller_id_in_from,$register_transport);
            } else {
                echo json_encode([
