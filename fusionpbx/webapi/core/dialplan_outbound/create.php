...
// END 
        ...
        if ($dialplanoutbound_enabled == "true" || $dialplanoutbound_enabled == "false") {
            $dialplanoutbound->post($con, $uuidDialPlan, $gateway_id,$gateway_2, $gateway_3, $expression_detail, $dialplanoutbound_prefix, $order, $domain, $context, $description, $dialplanoutbound_enabled, $id,$name);
        } else {
            echo json_encode([
