<?php
    ...
    if ($json_response['msg'] == 'true') {
        if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
            ...
            $access_control_id = $data->access_control_id;

            
            $firewall->update($con, $access_control_id, $access_control_name, $access_control_default, $access_control_description, $access_control_nodes, $id);
