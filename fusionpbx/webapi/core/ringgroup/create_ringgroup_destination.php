<?php
    ...
    if ($json_response['msg'] == 'true') {
        ...
        if ($ringGroupDestination_enabled == "true" || $ringGroupDestination_enabled == "false") {
            $ringGroup->postDestination($con, $uuidRingGroupDestination, $ring_group_id, $domain, $destination_number, $destination_delay, $destination_timeout, $ringGroupDestination_enabled, $id);
        } else {
            echo json_encode([
