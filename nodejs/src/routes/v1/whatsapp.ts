...
whatsapp.get("/webhook", whatsappCtrl.webhookVerified);
...
whatsapp.get(
  "/wp-conversation/company/:receiver_id",
  authUser,
  whatsappListCtrl.whatsappCompanyRecord
);
whatsapp.get(
  "/wp-conversation/user/:receiver_id",
  authUser,
  whatsappListCtrl.whatsappUserRecord
);
whatsapp.put(
  "/config",
  authUser,
  whatsappCtrl.ConfigWhatssapAToken
);
whatsapp.get(
  "/config",
  authUser,
  whatsappCtrl.getWhatssapAUrl
);
