...
const addPhonebookData = async (req: Request, res: Response, next: NextFunction) => {
        try {
...
const editPhonebookData = async (req: Request, res: Response, next: NextFunction) => {
        try {
                let data: any = req.body
...
const getPhonrbookRecord = async (req: Request, res: Response, next: NextFunction) => {
        try {
                let data: any = req.body
                ...
                const phonebook_list: any = await phonebook.find(find_query)
                .sort({ createdAt: -1 })
                .limit(limit)
                .skip(skip);


                const total_msg_count: any = await phonebook.find(find_query).countDocuments()
...
const deletePhonrbookData = async (req: Request, res: Response, next: NextFunction) => {
        try {
                let data: any = req.body
                let phonebook_id: any = data.phonebook_id
...
const getPhonrbookDataById = async (req: Request, res: Response, next: NextFunction) => {
        try {
                let data: any = req.body
                let phonebook_id: any = data.phonebook_id
...
export default { addPhonebookData, getPhonrbookRecord, editPhonebookData, deletePhonrbookData, getPhonrbookDataById }
