    ...
    resources: {
        ...
        translation: {
          ...
          "Note: To set up a Meta account, tap on the 'Access Token' link icon. After completing the configuration, copy the callback URL and verify the token, then paste them into the WhatsApp portal to finish the setup.":
            "Ohje: Luo Meta-tili napauttamalla 'Access Token' -linkkikuvaketta. Kun määritykset on tehty, kopioi callback-URL-osoite ja vahvista tunnus ja liitä ne sitten WhatsApp-portaaliin asennuksen viimeistelemiseksi.",
          "Callback URL": "Callback URL",
          "Verify token": "Verify token",
          "Access Token": "Access Token",
          "Whatsapp Number": "WhatsApp numero",
          "Phone number ID": "Puhelinnumero ID",
          "Enter Phone number ID": "Syötä Puhelinnumero ID",
          "Enter Whatsapp Number": "Syötä Whatsapp numero",
          "Enter WhatsApp API access token": "Anna WhatsApp API -käyttötunnus",
          "Call recording": "Puhelutallennus",
          "Copied successfully!": "Kopiointi onnistui",
          "Whatsaap Token Added Successfully":
            "Whatsaap Token lisätty onnistuneesti",
