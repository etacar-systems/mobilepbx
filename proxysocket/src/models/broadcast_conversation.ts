...
export interface broadcast_conversationModel extends broadcast_conversation,Document{}
...
export default mongoose.model<broadcast_conversationModel>("broadcast_conversation", prepSchema);